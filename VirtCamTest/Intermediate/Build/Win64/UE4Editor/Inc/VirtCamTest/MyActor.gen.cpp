...
#include "VirtCamTest/Public/MyActor.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	VIRTCAMTEST_API UClass* Z_Construct_UClass_AMyActor_NoRegister();
	VIRTCAMTEST_API UClass* Z_Construct_UClass_AMyActor();
	ENGINE_API UClass* Z_Construct_UClass_AActor();
	UPackage* Z_Construct_UPackage__Script_VirtCamTest();
// End Cross Module References
	...
	UObject* (*const Z_Construct_UClass_AMyActor_Statics::DependentSingletons[])() = {
		...
		(UObject* (*)())Z_Construct_UPackage__Script_VirtCamTest,
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(AMyActor, 1624697566);
	template<> VIRTCAMTEST_API UClass* StaticClass<AMyActor>()
	{
		return AMyActor::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMyActor(Z_Construct_UClass_AMyActor, &AMyActor::StaticClass, TEXT("/Script/VirtCamTest"), TEXT("AMyActor"), false, nullptr, nullptr, nullptr);
