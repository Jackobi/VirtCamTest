...
#include "RemoteCameraOutputSession.generated.h"

UCLASS()
class REMOTECAMERACORE_API URemoteCameraOutputSession : public URemoteCameraOutputBase
{
	GENERATED_BODY()
...
public:
	...
	// The default dummy UMG to use when we haven't selected any particular widget;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Output")
		TSubclassOf<UUserWidget> DefaultDummyUMGClass;
